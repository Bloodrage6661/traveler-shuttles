...
export default function Navbar() {
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-24 sm:h-32">
            ...
            <Link href="/" className="flex items-center group" aria-label="Traveler Shuttles and Tours — home">
              <Image
                ...
                height={520}
                priority
                className="h-20 sm:h-28 w-auto transition-transform group-hover:scale-105"
              />
            </Link>
      ...
      {pathname !== "/" && <div className="h-24 sm:h-32" style={{ background: "linear-gradient(90deg, #133820 0%, #132950 100%)" }} />}
    </>
  );
}
